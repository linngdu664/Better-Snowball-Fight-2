...
public class ParticleUtil {
     ...
     */
    public static void spawnForwardConeParticles(Level pLevel, Entity entity, Vec3 sightVec, ParticleOptions particleOptions, float r, float aStep, float rStep, double loweredVision) {//particleOptions=ParticleTypes.SNOWFLAKE r=4.5 deg=30 d=0.5f
    ...
    public static void spawnForwardConeParticles(Level pLevel, double eX, double eY, double eZ, Vec3 sightVec, ParticleOptions particleOptions, float r, float aStep, float rStep, double loweredVision) {//particleOptions=ParticleTypes.SNOWFLAKE r=4.5 deg=30 d=0.5f
