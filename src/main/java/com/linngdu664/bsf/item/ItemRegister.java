...
public class ItemRegister {
    ...
    public static final RegistryObject<Item> EXPLOSIVE_SNOWBALL_STORAGE_TANK = ITEMS.register("explosive_snowball_storage_tank", ExplosiveSnowballStorageTank::new);
    public static final RegistryObject<Item> SPECTRAL_SNOWBALL_STORAGE_TANK = ITEMS.register("spectral_snowball_storage_tank", SpectralSnowballStorageTank::new);
    public static final RegistryObject<Item> FROZEN_SNOWBALL_STORAGE_TANK = ITEMS.register("frozen_snowball_storage_tank", FrozenSnowballStorageTank::new);
    public static final RegistryObject<Item> POWDER_SNOWBALL_STORAGE_TANK = ITEMS.register("powder_snowball_storage_tank", PowderSnowballStorageTank::new);

    public static final RegistryObject<Item> LIGHT_MONSTER_TRACKING_SNOWBALL_STORAGE_TANK = ITEMS.register("monster_tracking_snowball_storage_tank", LightMonsterTrackingSnowballStorageTank::new);
    public static final RegistryObject<Item> HEAVY_MONSTER_TRACKING_SNOWBALL_STORAGE_TANK = ITEMS.register("monster_tracking_snowball_with_damage_storage_tank", HeavyMonsterTrackingSnowballStorageTank::new);
    public static final RegistryObject<Item> EXPLOSIVE_MONSTER_TRACKING_SNOWBALL_STORAGE_TANK = ITEMS.register("explosive_monster_tracking_snowball_storage_tank", ExplosiveMonsterTrackingSnowballStorageTank::new);
    public static final RegistryObject<Item> LIGHT_PLAYER_TRACKING_SNOWBALL_STORAGE_TANK = ITEMS.register("player_tracking_snowball_storage_tank", LightPlayerTrackingSnowballStorageTank::new);
    public static final RegistryObject<Item> HEAVY_PLAYER_TRACKING_SNOWBALL_STORAGE_TANK = ITEMS.register("player_tracking_snowball_with_damage_storage_tank", HeavyPlayerTrackingSnowballStorageTank::new);
    public static final RegistryObject<Item> EXPLOSIVE_PLAYER_TRACKING_SNOWBALL_STORAGE_TANK = ITEMS.register("explosive_player_tracking_snowball_storage_tank", ExplosivePlayerTrackingSnowballStorageTank::new);

    public static final RegistryObject<Item> MONSTER_GRAVITY_SNOWBALL_STORAGE_TANK = ITEMS.register("gravity_snowball_to_monster_storage_tank", MonsterGravitySnowballStorageTank::new);
    public static final RegistryObject<Item> PROJECTILE_GRAVITY_SNOWBALL_STORAGE_TANK = ITEMS.register("gravity_snowball_to_projectile_storage_tank", ProjectileGravitySnowballStorageTank::new);
    public static final RegistryObject<Item> MONSTER_REPULSION_SNOWBALL_STORAGE_TANK = ITEMS.register("repulsion_snowball_to_monster_storage_tank", MonsterRepulsionSnowballStorageTank::new);
    public static final RegistryObject<Item> PROJECTILE_REPULSION_SNOWBALL_STORAGE_TANK = ITEMS.register("repulsion_snowball_to_projectile_storage_tank", ProjectileRepulsionSnowballStorageTank::new);
    public static final RegistryObject<Item> BLACK_HOLE_SNOWBALL_STORAGE_TANK = ITEMS.register("black_hole_snowball_storage_tank", BlackHoleSnowballStorageTank::new);
}
