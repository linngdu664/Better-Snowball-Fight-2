...
public class HeavyMonsterTrackingSnowballItem extends BSFSnowballItem {
    ...
    public @NotNull InteractionResultHolder<ItemStack> use(@NotNull Level pLevel, Player pPlayer, @NotNull InteractionHand pUsedHand) {
        ...
        if (pPlayer.isShiftKeyDown()) {
            ...
            storageInTank(pPlayer, itemStack, ItemRegister.HEAVY_MONSTER_TRACKING_SNOWBALL_STORAGE_TANK.get());
        }
