...
import com.linngdu664.bsf.entity.snowball.tracking_snowball.LightMonsterTrackingSnowballEntity;
...
public class LightMonsterTrackingSnowballItem extends BSFSnowballItem {
    ...
    public @NotNull InteractionResultHolder<ItemStack> use(@NotNull Level pLevel, Player pPlayer, @NotNull InteractionHand pUsedHand) {
        ...
        if (pPlayer.isShiftKeyDown()) {
            ...
            storageInTank(pPlayer, itemStack, ItemRegister.LIGHT_MONSTER_TRACKING_SNOWBALL_STORAGE_TANK.get());
        }
